                    ...
                    <div className="col-lg-5 col-md-10">
                        <div className="payment-gateway-text">
                            ...
                            <p className="text-white m-0">
                                Double down on your growth efforts and take your customer journey and employee satisfaction
                                to new heights with Hireya, a leading expert in digital transformation for Banking and Financial Services.
                            </p>
                            <div
                            ...
                            ><ModalVideo
                                ...
                                />
                                <Link to="/contact-us" className="btn-gradient-sqr me-3">Contact us</Link>
